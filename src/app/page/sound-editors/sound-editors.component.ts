...
@Component({
  ...
  template: '<app-persons [countries$]="soundEditorService.getCountries" [personService]="soundEditorService" viewTitle="Ingénieurs du son" cookieName="sound-editors-config"></app-persons>'
})
