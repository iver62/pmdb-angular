...
@Component({
  ...
  template: '<app-persons [countries$]="costumierService.getCountries" [personService]="costumierService" viewTitle="app.costumiers" cookieName="costumiers-config"></app-persons>'
})
