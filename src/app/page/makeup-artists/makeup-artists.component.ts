...
@Component({
  ...
  template: '<app-persons [countries$]="makeupArtistService.getCountries" [personService]="makeupArtistService" viewTitle="Maquilleurs" cookieName="makeup-artists-config"></app-persons>'
})
