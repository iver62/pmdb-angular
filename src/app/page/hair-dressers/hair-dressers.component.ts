...
@Component({
  ...
  template: '<app-persons [countries$]="hairDresserService.getCountries" [personService]="hairDresserService" viewTitle="app.hair_dressers" cookieName="hair-dressers-config"></app-persons>'
})
