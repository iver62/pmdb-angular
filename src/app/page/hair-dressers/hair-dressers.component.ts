...
@Component({
  ...
  template: '<app-persons [countries$]="hairDresserService.getCountries" [personService]="hairDresserService" viewTitle="Coiffeurs" cookieName="hair-dressers-config"></app-persons>'
})
