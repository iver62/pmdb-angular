...
@Component({
  ...
  template: '<app-persons [countries$]="stuntmanService.getCountries" [personService]="stuntmanService" viewTitle="app.stuntmen" cookieName="stuntmen-config"></app-persons>'
})
